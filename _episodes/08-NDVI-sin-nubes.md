...
Una vez que las tareas se hayan ejecutado, tenemos que ir a la carpeta *RIO* de nuestro google drive.

<br>
<img src="../fig/08-Drive.png" border = "10" width="90%" height="90%">
<br><br>

Enseguida hay que descargar las imágenes para posterior análisis en un programa SIG (p.ej. QGIS):
